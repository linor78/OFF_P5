...
class view():
    def __init__(self, s):
        # The class is initialised by getting the select class which it will
        # use to get the information to print
        self.s = s
 ...
 action:\n')
    ...
    def choose_category(self):
        # Function that print all the categories present in the categories
        #  table and ask the user to select one and send it to the controller
        category = 0
    ...
    def choose_product(self, category):
        ...
        query = query + str(category) + ' order by rand() limit 10;'
